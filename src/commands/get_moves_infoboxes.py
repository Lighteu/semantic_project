...
def main() :
    with open('data/python-data/move_pages_list.json', 'r') as file:
        data = json.load(file)
    ...
    for datum in tqdm(data) :
        try :
            ...
            continue
        infobox = None
        infobox = extract_infobox(wikitext, "MoveInfobox")
        if infobox : 
    ...
    with open('data/python-data/infoboxes/move_infoboxes.json', 'w', encoding='utf-8') as file:
